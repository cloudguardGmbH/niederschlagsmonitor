...
- **Skalen (`src/lib/scale.ts`):** runde Obergrenzen über die 1-2-2.5-5-10er-Reihe (`niceCeil`); `axisTicks` beschriftet IMMER das Achsenmaximum selbst plus runde Zwischenwerte (Zwischentick entfällt unter 0,45 · Schritt vor dem Maximum) und „0“ an der Grundlinie — der höchste Balken ist stets gegen eine beschriftete Linie ablesbar. Über der Skalenobergrenze bleibt **Kopffreiheit** (Haupt-Panel 20 px, schmal 14; Kumulativ 10): trifft das Datenmaximum die Obergrenze exakt (5,0 auf einer 5er-Achse), endet der Balken an der beschrifteten Maximallinie, nie an der Blattkante; der Raum darüber gehört der Anker-Annotation. Haupt-Panel 3er-Teilung, Kumulativ 2er; Zeitschritte 3h/6h/24h/96h nach Spannweite.
